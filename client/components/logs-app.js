...
const Logs = () => {
  return (
    <div className="relative w-1/2 m-8">
      <div className="border-r-2 border-gray-500 absolute h-full top-0 ml-4" />
      <ul className="list-none m-0 p-0">
        ...
        <li className="mb-2">
          ...
          <div className="ml-12">
            ...
            deserunt excepturi sunt pariatur consequuntur eveniet molestias ea quia? Magni veniam
            illo optio tempora modi exercitationem qui adipisci ex.
          </div>
        </li>
        <li className="mb-2">
          <div className="flex items-center mb-1">
          ...
          <div className="ml-12">
            ...
            minima vero hic impedit cumque, blanditiis autem distinctio facere dolor atque facilis,
            eos, labore sunt iusto. Beatae, quas, dolorem?
          </div>
        </li>
      </ul>
    </div>
